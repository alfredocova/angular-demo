...
let UserService = class UserService {
    ...
    getUsers() {
        return this.http.get(this.userUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log('Usuarios - lista')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getUsers', [])));
    }
    /** buscar usuario por id */
    getUser(id) {
        const url = `${this.userUrl}/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`perfil de usuario id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getUser ID=${id}`)));
    }
    //////// Save methods //////////
    /** agregar usuario */
    addUser(user) {
    ...
    /** actualizar usuario */
    updateUser(user) {
        return this.http.put(this.userUrl, user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`usuario acutalizado con id=${user.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateUser')));
    }
    /**
     * Manejo de errores
     */
...
let UsersComponent = class UsersComponent {
    ...
    add(name) {
        ...
        this.userService.addUser({ name, id: this.nid++ })
            .subscribe(user => {
